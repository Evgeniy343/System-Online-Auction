...
function UpdateAuctionSection2(props) {
    return (
        <Container>
            <Row>
                <Col xs={6} md={4}>
                    <FormGroup controlId="formProductPhoto1">
                        ...
                        <Controller
                            ...
                            defaultValue={props.auction.product.photos[0]}
                ...
                <Col xs={6} md={4}>
                    <FormGroup controlId="formProductPhoto2">
                        ...
                        <Controller
                            defaultValue={props.auction.product.photos[1]}
                            control={props.control}
                ...
                <Col xs={6} md={4}>
                    <FormGroup controlId="formProductPhoto3">
                        ...
                        <Controller
                            defaultValue={props.auction.product.photos[2]}
                            control={props.control}
...
export default UpdateAuctionSection2;