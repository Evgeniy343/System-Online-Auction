...
function UpdateAuctionSection1(props) {
            ...
            <Row>
                <Col xs={6} md={4}>
                    <FormGroup controlId="formProductName">
                        ...
                        <Controller
                            defaultValue={props.auction.product.name}
                ...
                <Col xs={6} md={4}>
                    <FormGroup controlId="formBasicCategory">
                        ...
                        <Controller
                            control={props.control}
                            defaultValue={props.auction.product.category}
                ...
                <Col xs={6} md={4}>
                    <FormGroup controlId="formBasicDescription">
                        ...
                        <Controller
                            control={props.control}
                            defaultValue={props.auction.product.description}
...
export default UpdateAuctionSection1;