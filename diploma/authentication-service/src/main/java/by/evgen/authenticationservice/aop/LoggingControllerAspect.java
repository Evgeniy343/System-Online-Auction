package by.evgen.authenticationservice.aop;
...
public class LoggingControllerAspect {
    ...
    @Pointcut("within(by.evgen.authenticationservice.authentication.AuthenticationController)")
    public void logAuthenticationController() {
    }

    @Around("logAuthenticationController()")
