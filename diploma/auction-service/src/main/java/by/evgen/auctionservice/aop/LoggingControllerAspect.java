package by.evgen.auctionservice.aop;
...
public class LoggingControllerAspect {
    ...
    @Pointcut("within(by.evgen.auctionservice.controller.AuctionController)")
    public void logAuctionController() {
    }

    @Around("logAuctionController()")
