package by.evgen.productservice.aop;
...
public class LoggingControllerAspect {
    ...
    @Pointcut("within(by.evgen.productservice.controller.ProductController)")
    public void logProductController() {
    }

    @Around("logProductController()")
